...
public class Liste_scfi_books extends AppCompatActivity implements LoadJSONTask.Listener, AdapterView.OnItemClickListener {

private ListView mListView;

public static final String URL = "http://86.64.78.35/data_books/liste_scfi.json";
...
private void loadListView() {
        ...
        ListAdapter adapter = new SimpleAdapter(Liste_scfi_books.this, mAndroidMapList, R.layout.list_item,
