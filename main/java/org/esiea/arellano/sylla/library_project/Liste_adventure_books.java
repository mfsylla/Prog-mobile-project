...
public class Liste_adventure_books extends AppCompatActivity implements LoadJSONTask.Listener, AdapterView.OnItemClickListener {

    private ListView mListView;

    public static final String URL = "http://86.64.78.35/data_books/liste_aventure.json";
    ...
    private void loadListView() {
        ...
        ListAdapter adapter = new SimpleAdapter(Liste_adventure_books.this, mAndroidMapList, R.layout.list_item,
